...
from camera import CameraManager, center_crop_resize, CAMERA_WORKING_SIZE, HAND_YOLO_ROTATE_CODE, BASE_YOLO_ROTATE_CODE
...
class RoboticInteraction:
    ...
    def _align_base_camera_to_target(self, base_uv: tuple[float, float]) -> bool:
        image_center_x = CAMERA_WORKING_SIZE / 2.0
